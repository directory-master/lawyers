    ...
    h('div', { class: 'lc-card' },
      ...
      h('div', { class: 'lc-band' },
        h('div', { class: 'lc-tabs' },
          ...
          l.status === 'temporarily_closed' && h('span', { class: 'lc-tab lc-tab--closed' }, 'Temporarily closed'),
          l.status === 'permanently_closed' && h('span', { class: 'lc-tab lc-tab--closed' }, 'Permanently closed')),
        saveButton(l)),
